...
class DeliverData extends StatefulWidget {


  @override
  _DeliverDataState createState() => _DeliverDataState();
}

class _DeliverDataState extends State<DeliverData> {
                ...
                child: Container(
                    ...
                    Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('43',style: CartStyles,),
                          Text('Commandes acceptées',style: CartStyles,)
                        ],
                      ),
                    )
                ),
              ...
              child: Container(
                child: Column(
                  children: [
                    Row(
                      children: [
                        Expanded(child: buildContainerlocation(Icons.location_on_outlined,'LOCATION','SANTA LUCIA (DEIDO)')),
